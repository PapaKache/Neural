...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(275, 567)
        self.centralWidget = QtWidgets.QWidget(MainWindow)
        self.centralWidget.setObjectName("centralWidget")
        self.pushButtonTrain = QtWidgets.QPushButton(self.centralWidget)
        self.pushButtonTrain.setGeometry(QtCore.QRect(10, 370, 251, 41))
        ...
        self.progressBarPercent.setGeometry(QtCore.QRect(10, 500, 261, 23))
